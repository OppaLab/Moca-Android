...
import com.oppalab.moca.adapter.Sticker4Adapter

class Sticker4Fragment : BottomSheetDialogFragment(), Sticker4Adapter.StickerAdapterClickListener {
    ...
    internal lateinit var a1Adapter: Sticker4Adapter

    internal var sticker_selected = -1

    companion object {
        internal var instance:Sticker4Fragment?=null

        fun getInstance():Sticker4Fragment {
            if (instance == null) {
                instance = Sticker4Fragment()
            }
            return instance!!
        }
    }
    ...
    override fun onCreateView(
        ...
        recycler_sticker.adapter = Sticker4Adapter(requireContext(), this)
